...
def run():
    ...
    with tabs[3]:
        ...
        st.markdown(pretty_title("직접 맞추기 vs 머신러닝에게 맡기기", "#ede7f6", "#d1c4e9"), unsafe_allow_html=True)
        st.write(
        ...
        with col_p2:
            ...
            st.markdown(pretty_title("예측하고 바로 확인하기", "#fce4ec", "#f8bbd0"), unsafe_allow_html=True)
        ...
        st.markdown(pretty_title("결과 해석", "#fff8e1", "#ffecb3"), unsafe_allow_html=True)
        ...
        render_value_cards(
            [
                ...
                },
                {
                    ...
                    "detail": "이 연도 값을 직접 예측하고 AI 결과와 비교합니다.",
                    "bg": "#ede7f6",
                    "border": "#b39ddb",
                },
            ],
    ...
    with tabs[4]:
                ...
                if class_num in valid_classes:
                    render_value_cards(
                        [
                            ...
                            {
                                "title": "학번 / 이름",
                                "value": f"{stu_id} {stu_name}",
                                "detail": "학생 정보가 올바르면 바로 PDF를 받을 수 있습니다.",
                                "bg": "#f1f8e9",
                                "border": "#aed581",
                            },
                        ]
                    )
                    st.success("학생 정보를 입력했으므로 바로 포트폴리오를 저장할 수 있습니다. 아래 답변을 작성한 뒤 다시 저장하면 최신 내용이 함께 반영됩니다.")
                    ...
                    with col_btn1:
                        st.download_button(
                            ...
                            data=pdf_bytes,
                            file_name=f"{stu_id}_{stu_name}_4차시_탐구포트폴리오.pdf",
                    ...
                    st.error("해당 학급(1, 2, 5, 6반)의 학번인지 다시 확인해 주세요.")
            else:
                st.warning("올바른 5자리 학번을 입력해 주세요.")
        else:
            st.info("모둠 이름, 학번, 이름을 입력하면 바로 탐구 포트폴리오를 저장할 수 있습니다.")
        ...
        if group_name and stu_id and social_meaning and action_plan and q_deep:
