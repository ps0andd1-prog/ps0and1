...
- 추가로 보여 주고 싶은 내용: {clean_text(st.session_state.get("d6_info_key_data", ""), "data5 자료를 바탕으로 앱에 추가하고 싶은 내용이나 화면 요소를 적어 주세요.")}
        ...
        with material_col:
            ...
            with custom_btn:
                if st.button(
                    ...
                    st.session_state["d6_material_mode"] = "학생이 직접 프로젝트 자료 설계하기"
                    st.rerun()
            if using_future_materials():
